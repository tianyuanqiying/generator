...
@Slf4j
@Component
public class ${componentName}CreateSubmitApplicationDataSaveValidator extends AbstractParamDataValidator {

    public ${componentName}CreateSubmitApplicationDataSaveValidator(${componentName}ParamHandler paramHandler, ${componentName}ParamDataHandler paramDataHandler) {
