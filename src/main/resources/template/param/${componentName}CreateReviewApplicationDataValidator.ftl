...
@Slf4j
@Component
public class ${componentName}CreateReviewApplicationDataValidator extends AbstractParamDataValidator {

    public ${componentName}CreateReviewApplicationDataValidator(${componentName}ParamHandler paramHandler, ${componentName}ParamDataHandler paramDataHandler) {
