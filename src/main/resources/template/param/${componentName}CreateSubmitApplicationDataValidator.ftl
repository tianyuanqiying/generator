...
@Slf4j
@Component
public class ${componentName}CreateSubmitApplicationDataValidator extends AbstractParamDataValidator {

    public ${componentName}CreateSubmitApplicationDataValidator(${componentName}ParamHandler paramHandler, ${componentName}ParamDataHandler paramDataHandler) {
