...
@Slf4j
@Component
public class ${componentName}UpdateSubmitApplicationDataSaveValidator extends AbstractParamDataValidator {

    public ${componentName}UpdateSubmitApplicationDataSaveValidator(${componentName}ParamHandler paramHandler, ${componentName}ParamDataHandler paramDataHandler) {
